...
dense_layer = Dense(256, activation='relu')(input_image)
dense_dropout = Dropout(p=dropout_probability)(dense_layer) 
dense_layer2 = Dense(256, activation='relu')(input_image)
dense_dropout2 = Dropout(p=dropout_probability)(dense_layer2) 
dense_layer3 = Dense(256, activation='relu')(input_image)
dense_dropout3 = Dropout(p=dropout_probability)(dense_layer3) 
dense_layer4 = Dense(256, activation='relu')(input_image)
dense_dropout4 = Dropout(p=dropout_probability)(dense_layer4) 


dense_layer5 = Dense(256, activation='relu')(dense_dropout)
dense_dropout5 = Dropout(p=dropout_probability)(dense_layer5) 
dense_layer6 = Dense(256, activation='relu')(dense_dropout2)
dense_dropout6 = Dropout(p=dropout_probability)(dense_layer6)
dense_layer7 = Dense(256, activation='relu')(dense_dropout3) 
dense_dropout7 = Dropout(p=dropout_probability)(dense_layer7) 
dense_layer8 = Dense(256, activation='relu')(dense_dropout4)
dense_dropout8 = Dropout(p=dropout_probability)(dense_layer8)

dense_concatenate = keras.layers.concatenate([dense_dropout5, dense_dropout6, dense_dropout7, dense_dropout8])
...
file_path = "/media/ailab/songyoungtak/keras-master/examples/saved_models/mpl3.hdf5"
