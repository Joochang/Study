...
dense_layer = Dense(512, activation='relu')(input_image)
dense_dropout = Dropout(p=dropout_probability)(dense_layer) 
dense_layer2 = Dense(512, activation='relu')(input_image)
dense_dropout2 = Dropout(p=dropout_probability)(dense_layer2) 
 
dense_layer3 = Dense(512, activation='relu')(dense_dropout)
dense_dropout3 = Dropout(p=dropout_probability)(dense_layer3) 
dense_layer4 = Dense(512, activation='relu')(dense_dropout2)
dense_dropout4 = Dropout(p=dropout_probability)(dense_layer4)

dense_concatenate = keras.layers.concatenate([dense_dropout3, dense_dropout4])
...
file_path = "/media/ailab/songyoungtak/keras-master/examples/saved_models/mpl2.hdf5"
